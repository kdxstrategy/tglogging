...
# Telegram лимит на текст сообщения — 4096 символов.
# В сообщение добавляется обёртка "<pre>k-server\n...</pre>" (20 символов)
# плюс html.escape может удлинить строку (<, >, &, ", ' превращаются в 4-6 символов).
# Поэтому MAX_MESSAGE_LEN (лимит на сырой текст) берём с запасом.
...
class TelegramLogHandler(StreamHandler):
    ...
    MAX_MESSAGE_LEN = 3500  # запас на html.escape + обёртку
